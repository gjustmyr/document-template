...
function updateDisplay() {
    ...
    document.getElementById('displayYearProgram').textContent = document.getElementById('yearProgram').value;
    document.getElementById('displayCompanyAddress').textContent = document.getElementById('companyAddress').value;
    document.getElementById('displayRequiredHours').textContent = document.getElementById('requiredHours').value;
}
...
function generateSchedule() {
    ...
    // Update total hours
    document.getElementById('totalHours').innerHTML = `<strong>${totalHours.toFixed(1)}</strong>`;

    // Scroll to table
    document.querySelector('.timeframe-table').scrollIntoView({ behavior: 'smooth', block: 'start' });
}
...
function updateTotal() {
    ...
    document.getElementById('totalHours').innerHTML = `<strong>${total.toFixed(1)}</strong>`;
}
...
function resetForm() {
    if (confirm('Are you sure you want to reset the form? All data will be lost.')) {
        ...
        document.querySelectorAll('.days-selector input[type="checkbox"]').forEach((checkbox, index) => {
